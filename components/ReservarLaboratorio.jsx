...
import Centroamerica1 from '/img/centroamerica1.jpg';
import logo from '/img/logo-ceutec-retina.png';
import { Header } from './Header';
import { useNavigate } from 'react-router-dom';

export const ReservarLaboratorio = () => {
        ...
        <>
            ...
            <div className='container mt-4'>
                ...
                <div className='card p-4'>
                    <h2 className='text-center'>Sede Ceutec: Laboratorios Centroamérica - Tegucigalpa</h2>
                    <div class="row">
                        <div class="col-md-6">
                            <form>
                                <div className='mb-3'>
                        ...
                        <div class="A col-md-6 mt-5 text-center">
                            <img class="img-fluid mt-5 img-large" src={Centroamerica1} alt="Card image cap" />
                        </div>
