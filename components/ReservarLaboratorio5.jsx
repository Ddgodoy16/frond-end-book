...
export const ReservarLaboratorio5 = () => {
        ...
        <>
            ...
            <div className='container mt-4'>
                ...
                <div className='card p-4'>
                    <h2 className='text-center'>Sede Ceutec: Laboratorios La Ceiba</h2>
                    <div class="row">
                        <div class="col-md-6">
                            <form>
                                <div className='mb-3'>
                        ...
                        <div class="A col-md-6 mt-5 text-center">
                            <img class="img-fluid mt-5 img-large" src={Ceiba} alt="Card image cap" />
                        </div>
